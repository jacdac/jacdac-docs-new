...
The documentation in these pages form the basis for the Jacdac Device Development Kit (DDK). The DDK is for hardware designers, firmware developers and manufacturers who wish to create their own Jacdac [devices](/devices). Important additional materials that are part of the DDK are hosted on separate Github repos for [DDK reference materials](https://github.com/jacdac/jacdac-ddk) and our various [firmware implementations](https://microsoft.github.io/jacdac-docs/ddk/firmware/).
